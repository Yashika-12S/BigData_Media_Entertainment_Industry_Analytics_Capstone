...
| ----- | ------------------------------------------------ | ---------------------------------------------------------------------------------- | --------------------------------- | -------------------------------------------------------------------------------------- |
| **1** | **Box Office / Streaming Success Prediction** | Predict whether a movie will be successful based on budget, votes, and popularity. | Logistic Regression (Spark MLlib) | Accuracy **77%**, AUC **0.85**. *Vote count* & *popularity* were strongest predictors. |
